  ...
  return (
    <div>
      ...
      <div className="relative h-[220px] overflow-hidden bg-[url('/images/about/aboutBanner.png')] bg-cover bg-no-repeat p-12 text-white mt-22 md:mt-28">
        <h1 className="md:ml-5 md:mt-6 mt-5 md:text-5xl text-3xl font-bold">Audit Kepabeanan dan Cukai</h1>
        <h2 className="font-lg md:ml-5 text-lg">Konsultasi Bersama Expert</h2>
      </div>
      {/* Jumbotron 1*/}
