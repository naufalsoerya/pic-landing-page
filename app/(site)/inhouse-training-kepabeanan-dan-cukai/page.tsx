      ...
      <section className="relative pt-28 pb-12 sm:pt-36 sm:pb-16 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-slate-900 tracking-tighter uppercase">
            Inhouse <span className="text-gojek-green">Training</span> <br />Kepabeanan & Cukai
          </h1>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16">
            <div className="space-y-8">
              <div className="rounded-[40px] overflow-hidden shadow-2xl border-8 border-white">
                <img className="w-full h-auto object-cover" src="/images/about/service5.jpg" alt="Inhouse Training Kepabeanan dan Cukai" />
              </div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed font-medium">
                <p>
                  ...
                  perlu mendapatkan bekal pelatihan untuk meningkatkan kompetensinya.
                </p>
                <p>
