    ...
    submenu: [
      {
        ...
        newTab: false,
        path: "https://pictraining.co.id/online",
      },
      {
        id: 44,
        title: "Kelas Offline Kepabeanan",
        newTab: false,
        path: "https://pictraining.co.id/offline",
      },
      {
        id: 46,
        title: "eCourse PIC",
        newTab: false,
        path: "https://pictraining.id/ecourse",
      },
      {
        id: 47,
        title: "Kelas Kepabeanan Advanced",
        newTab: false,
        path: "https://pictraining.co.id/advanced",
      },
      {
        id: 50,
        title: "Inhouse Training",
        newTab: false,
        path: "https://pictraining.co.id/inhouse",
      },
    ],
  },
  {
